...
const supportFunctionKeywords = [
  ...
  "getfreecell", "getgdskilllv", "getgroupid", "getgroupitem", "getgroupitemrate", "getguildalliance", "getguildmaster", "getguildmasterid", "getguildmember", "getguildname", "gethominfo", "getinventorylist", "getitem", "getitem2", "getitem3", "getitem4","getitemamount", "getitembound", "getitembound2", "getitembound3", "getitembound4",
  ...
  "pvpoff", "pvpon", "query_logsql", "query_sql", "questinfo", "questinfo_refresh", "rand", "readbook", "readparam", "refine", "removespecialeffect", "removespecialeffect2", "rentalcountitem", "rentalcountitem2", "rentalcountitem3", "rentitem", "rentitem2", "rentitem3", "rentitem4","repair", "repairall",
  ...
  "waitingroom2bg", "waitingroom2bg_single", "warp", "warpwaitingpc", "wedding", "heal", "isloggedin", "getstatus", "getareaunits", "isdead", "removemapflag","startnpctimer","changecharsex","warpparty","itemheal","getgmlevel", "rid2name", "addrid", "areawarp", "kick", "pushpc", "changelook",
  "jobchange","warpguild","warppartner",
];
